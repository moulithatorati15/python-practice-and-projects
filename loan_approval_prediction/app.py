...
st.markdown(
    ...
    .stApp {
        ...
        animation:
            backgroundAnimation 18s ease infinite;
...
st.markdown(
    "**Enter applicant details below to predict whether the "
...
st.caption(
    "Powered by XGBoost • FastAPI • Streamlit"
)
